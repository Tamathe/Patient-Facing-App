...
RUN  v2.1.9 C:/Patient centered
 ...
 ✓ src/domain/safety.test.ts (16 tests) 15ms
 ✓ src/domain/crisis-red-flags.test.ts (183 tests) 140ms
 ✓ src/domain/front-door.test.ts (41 tests) 87ms
 ✓ src/ai/safety-gate.test.ts (46 tests) 130ms

 Test Files  4 passed (4)
      Tests  286 passed (286)
   Start at  12:15:48
   Duration  3.52s (transform 654ms, setup 893ms, collect 1.47s, tests 373ms, environment 5.27s, prepare 1.20s)
```
