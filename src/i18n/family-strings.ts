...
export const familyStrings: Record<Language, Record<FamilyStringKey, string>> = {
  en: {
    pageTitle: "Help for your family",
    demoBadge: "Demo — not an official service",
    intro: "We can point you to places that may help. We cannot say what your child has, and we cannot decide what you qualify for. Only the program can do that.",
    ...
    interviewTitle: "Tell us what is going on",
    interviewIntro: "Tell us what worries you, what you want for your child, and what you have already tried. We use your own words to find help. We do not diagnose.",
    interviewLabel: "What would you like help with?",
    interviewPlaceholder: "For example: My child is struggling with reading and I don't know what to ask the school for.",
  ...
  es: {
    pageTitle: "Ayuda para tu familia",
    demoBadge: "Demo — no es un servicio oficial",
    intro: "Podemos mostrarte lugares que pueden ayudar. No podemos decir qué tiene tu hijo o hija, ni decidir para qué califican. Solo el programa puede hacer eso.",
    ...
    interviewIntro: "Cuéntanos qué te preocupa, qué quieres para tu hijo o hija y qué ya intentaste. Usamos tus propias palabras para buscar ayuda. No diagnosticamos.",
